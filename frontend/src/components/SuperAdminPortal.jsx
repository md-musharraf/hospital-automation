          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 border-b border-[var(--border-color)]/20 pb-3">
            <div>
              ...
              <p className="text-[11px] text-[var(--text-secondary)] font-semibold mt-0.5">
                Select any registered hospital, clinic, lab or medical store from the list below to instantly
                edit or manage accounts.
              </p>
            </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      {hospitalList
                        .filter(
                          (h) =>
                            (h.type === 'Hospital' || h.type === 'Government Hospital') && h.id !== editHospId
                        )
                        .map((h) => (
                          <option key={h.id} value={h.id}>
                            {h.name} ({h.id})
