...
export function isToday(value?: Date | string | number | null): boolean {
...
export function onlyToday<T extends Record<string, any>>(
  records: T[] = [],
...
export function minutesSince(from?: Date | string | number | null): number {
