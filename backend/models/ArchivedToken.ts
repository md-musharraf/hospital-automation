...
const ArchivedToken: Model<any> =
  (mongoose.models && mongoose.models.ArchivedToken) ||
  mongoose.model<any>('ArchivedToken', ArchivedTokenSchema);
export default ArchivedToken;
module.exports = ArchivedToken;
