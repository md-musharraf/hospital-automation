...
const FacilityCredential: Model<any> =
  (mongoose.models && mongoose.models.FacilityCredential) ||
  mongoose.model<any>('FacilityCredential', FacilityCredentialSchema);
export default FacilityCredential;
module.exports = FacilityCredential;
